        ...
        <div className="ciccenic_floating_panels">
          ...
          <div className="ciccenic_info_panel">
            ...
            <p className="ciccenic_description">
              Objetivo: Desarrollar habilidades comunicativas en Lengua de Señas,
              capacitando a los participantes para interactuar de manera efectiva
              con la comunidad sorda y promoviendo la inclusión social.
            </p>
